...
class GroupController {
    ...
    static async getGroupById(req, res, next) {
        try {
            const user = req.user;
            const teacherId = GroupController.extractTeacherId(user);
            const group = await GroupService.getGroupById(req.params.id, teacherId);
    ...
    static async updateGroup(req, res, next) {
        try {
            const user = req.user;
            const teacherId = GroupController.extractTeacherId(user);
            const updatedGroup = await GroupService.updateGroup(req.params.id, teacherId, req.body);
    ...
    static async deleteGroup(req, res, next) {
        try {
            const user = req.user;
            const teacherId = GroupController.extractTeacherId(user);
            await GroupService.deleteGroup(req.params.id, teacherId);
