...
import { UserRole, SubscriptionStatus, SubscriptionPlan, PLAN_PRICES, PLAN_CONFIG, DURATION_LABELS, } from '../../common/enums/enum.service.js';
...
export class SubscriptionService {
    static async createSubscription(teacherId, data, session) {
        ...
        const finalStudentsCount = data.studentsCount ?? teacher.studentCount ?? 0;
