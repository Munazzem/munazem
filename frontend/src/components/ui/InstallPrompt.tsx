...
export function InstallPrompt() {
    ...
    useEffect(() => {
        ...
        // Show the prompt if we have the event or if it's iOS, and it hasn't been dismissed
        if ((deferredPrompt || isIosDevice) && !isDismissed) {
    ...
    if (isIos) {
        return (
            ...
            >
                ...
                <div className="mt-4 flex items-center justify-center gap-4 text-[10px] text-gray-400 border-t border-gray-50 pt-2">
